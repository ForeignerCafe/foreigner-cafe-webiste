...
export default function AuthLayout({
  ...
  return (
    ...
    >
      <div
        className={`min-h-screen relative flex items-center justify-center p-3 sm:p-4 lg:p-6 overflow-hidden ${onest.className}`}
      >
        {/* Background Image */}
          ...
          <div className="hidden lg:block space-y-6 xl:space-y-8 px-4 xl:px-8">
            ...
            <div className="flex items-center space-x-3 mb-8 xl:mb-12">
              <div className="w-10 h-10 xl:w-12 xl:h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center shadow-lg">
                <span className="text-white font-bold text-2lg xl:text-xl">
                  FC
                </span>
              </div>
              <span className="text-white text-3xl xl:text-4xl font-bold">
                Foreigner Cafe
              </span>
            </div>
