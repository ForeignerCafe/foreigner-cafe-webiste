...
export default function RatioOfDevicesChart({
  ...
  const processChartData = (data: ChartEntry[]) => {
  ...
  return (
    <Card
      className="border-0 shadow-sm dark:bg-[#28282B] bg-white dark:text-white h-full"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="h-8 gap-1 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:outline-none bg-transparent"
              >
                {timeframe}
