      ...
      <DialogContent className=" sm:max-w-[600px] w-[80%] p-4 sm:p-6">
        ...
        <div className=" grid gap-3 sm:gap-4 py-3 sm:py-4">
          ...
          <div className="relative w-full aspect-video rounded-[0.5rem] overflow-hidden shadow-lg border border-gray-200">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.2999999999997!2d-122.323000!3d37.563000!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808f9e7e7e7e7e7e%3A0x4e2b8a2b8a2b8a2b!2s60%20E%203rd%20Ave%20Ste%20108%2C%20San%20Mateo%2C%20CA%2094401!5e0!3m2!1sen!2sus!4v1678901234567!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
