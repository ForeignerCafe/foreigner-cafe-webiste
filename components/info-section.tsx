			...
			<div className="max-w-7xl mx-auto container-padding">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
					...
					<div className="animate-fade-in-up">
						<h3 className="text-lg font-display font-bold mb-6 tracking-wide text-black">
							OPEN HOURS
						</h3>
						<div className="space-y-4">
							...
							<div className="pt-2">
								...
								<div className="text-sm text-gray-600 leading-relaxed">
									Dine In & Takeaway: 7:30am 'til 4:00pm
								</div>
							</div>
					...
					<div
						...
						<div className="text-sm text-gray-600 space-y-6">
							<p className="leading-relaxed">
								Bookings of up to 12 people can book online and walk-ins are
								always welcome.
							</p>
							<div>
                <Button
                  ...
                  className="btn-primary text-sm font-bold tracking-wide hover-lift">
					...
					<div
						...
						<div className="text-sm text-gray-600 leading-relaxed">
							<p>
								Contact us to make a reservation for groups of 13 people or
								more.
							</p>
							<p className="pt-6">
								<button
